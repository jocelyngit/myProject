...
<head>
    ...
    <![endif]-->
    <title>Liste des projets-sélection d'un employé</title>
...
<div class="content-wrapper">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h4 class="page-head-line">Selection d'un employe</h4>
            </div>
        ...
        <form enctype="multipart/form-data" class="formoid-metro-cyan" style="background-color:#FFFFFF;font-size:14px;font-family:'Open Sans','Helvetica Neue','Helvetica',Arial,Verdana,sans-serif;color:#666666;max-width:480px;min-width:150px" method="post" action="<?php $_SERVER['PHP_SELF'];?>" ><div class="title"><h2></h2></div>
            ...
            <div class="element-select"><label class="title">Sélectionner un(e) employé(e)</label><div class="large"><span><select required name="choixemplistproj" >
            ...
            <div class="submit">
                <input type="submit" onsubmit="retour()" value="Annuler" name="clicsubmit" />
...
if (isset($_POST["clicsubmit"])){
    ...
    switch ($_POST["clicsubmit"])
    {
        case "Continuer":
        {
            if ( ($_POST["choixemplistproj"] != "0") )
            {
                $_SESSION["idchoixemplistproj"] = $_POST["choixemplistproj"];
                    header("location:Affichage_listproj_par_employe.php");
            }
            else
            {
