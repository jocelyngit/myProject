...
<div class="content-wrapper">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h4 class="page-head-line">clients</h4>
        ...
        <a href="page_enreg_client.php"><button class="btn btn-primary"><i class="fa fa-plus "></i> Ajouter un client </button></a>
        <br/>
        <br/>
            ...
            <div class="panel-body">
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        $requete = " SELECT nomclient, logincli, mailcli, telcli, nature
                                    FROM client";
