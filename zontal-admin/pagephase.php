            ...
            <div class="col-md-12">
                <div class="navbar-collapse collapse ">
                    <ul id="menu-top" class="nav navbar-nav navbar-right">
                        ...
                        <li><a class="menu-top-active" href="pagephase.php">phases</a></li>
            ...
            <div class="panel-body">
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        $requete = " SELECT idphase, nomphase, descriptionphase, nomprojet
                                      FROM phases, projet
                                      WHERE phases.idprojet = projet.idprojet";
