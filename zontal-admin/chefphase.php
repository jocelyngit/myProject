...
<div class="content-wrapper">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h4 class="page-head-line">Phases</h4>
        ...
        <a href="page_enreg_phase.php"><button class="btn btn-primary"><i class="fa fa-plus "></i> Ajouter une phase </button></a>
        <br/>
        <br/>

        <div class="panel panel-default">
            <div class="panel-heading">
                <strong>Liste des phases</strong>
            </div>
            <div class="panel-body">
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        $requete = " SELECT DISTINCT idphase, nomphase, descriptionphase, nomprojet
                                      FROM phases, projet, employe
                                      WHERE phases.idprojet IN (SELECT idprojet FROM projet, employe
                                                                WHERE projet.idemp = $id )
                                      AND phases.idprojet = projet.idprojet ";
                        ...
                        ";
                            ...
                            for ($t = 1; $t<= $nbligne; $t++)
                            {
                                ...
                                echo "<td><a href='page_modif_phase.php'  title='Modifier'><i class=\"fa fa-pencil\" onclick=''></i></a></td>";
