...
<div class="content-wrapper">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h4 class="page-head-line">Projets</h4>
        ...
        <a href="page_enreg_projet.php"><button class="btn btn-primary"><i class="fa fa-plus "></i> Ajouter un projet </button></a>
        <a href="listeprojet_selectionemp.php"><button class="btn btn-primary"><i class="fa fa-filter "></i> Trier par employés </button></a>
        <!--<a href="selectionprojaActiver.php"><button class="btn btn-primary">Débuter/clôture un projet</button></a>-->
        <br/>
        <br/>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                $requete = " SELECT nomprojet, datedebutpro, typepro, etatprojet, budget, nomemp, nomclient
                             FROM employe, projet, client
                             WHERE projet.idemp = employe.idemp
