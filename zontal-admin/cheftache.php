...
<div class="content-wrapper">
    <div class="container">
        ...
        <a href="page_enreg_tache.php"><button class="btn btn-primary"><i class="fa fa-plus "></i>Ajouter une tâche</button></a>
        <a href="chefplanifier.php"><button class="btn btn-primary">Planifier les tâches</button></a>
        <a href="chefAffecter.php"><button class="btn btn-primary">Affecter les ressources</button></a>
        <a href="selectiontacheaActiver.php"><button class="btn btn-primary">Débuter/Clôture une tâche</button></a>
        <a href="cheflistaffect.php"><button class="btn btn-primary">Liste des tâches affectées</button></a>
        <br/>
        <br/>
            ...
            <div class="panel-body">
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        $requete = " SELECT DISTINCT numero, nomtache, datedebT, datefinT, duree, nomprojet, nomphase,etatTache
                             FROM tache, projet, phases
                             WHERE tache.idprojet = projet.idprojet
                             AND  tache.idprojet = $id
