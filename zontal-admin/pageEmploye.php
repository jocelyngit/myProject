...
<div class="content-wrapper">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h4 class="page-head-line">Employes</h4>
        ...
        <a href="page_enreg_employe.php"><button class="btn btn-primary"><i class="fa fa-plus "></i> Ajouter un(e) employé(e) </button></a>
        <a href="selectionprojlistEmp.php"><button class="btn btn-primary"><i class="fa fa-filter "></i>Trier par projet </button></a>
        <br/>
        <br/>
            ...
            <div class="panel-body">
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        $requete = " SELECT nomemp, prenomemp, loginemp, mailemp, telemp, profil
                             FROM employe";
