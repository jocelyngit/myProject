...
<head>
    ...
    <![endif]-->
    <title>chef-list des affectations </title>
...
<div class="content-wrapper">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h4 class="page-head-line">Mes taches affectees</h4>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <strong>Liste des tâches affectées</strong>
            </div>
            <div class="panel-body">
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        $requete = " SELECT DISTINCT nomemp, nomtache, coutTotal, materiel
                                      FROM  affecter, employe, projet, tache
                                       WHERE  affecter.idemp = employe.idemp
