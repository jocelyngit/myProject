            ...
            <div class="col-md-12">
                <div class="navbar-collapse collapse ">
                    <ul id="menu-top" class="nav navbar-nav navbar-right">
                        ...
                        <li><a class="menu-top-active" href="cheflivrable.php">livrables</a></li>
...
<div class="content-wrapper">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h4 class="page-head-line">livrables</h4>
       ...
       <!-- <a href="page_enreg_livrable.php"><button class="btn btn-primary"><i class="fa fa-plus "></i> Ajouter un livrable </button></a>
        <br/>
        <br/>----------------------------------------------------------------------------------------------------------------------------->

        <div class="panel panel-default">
            <div class="panel-heading">
                <strong>Liste des livrables</strong>
            </div>
            <div class="panel-body">
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        $requete = " SELECT nomprojet, datedebutpro, typepro, budget, nomemp, nomclient
