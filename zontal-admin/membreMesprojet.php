            ...
            <div class="col-md-12">
                <div class="navbar-collapse collapse ">
                    <ul id="menu-top" class="nav navbar-nav navbar-right">
                        <li><a class="menu-top-active" href="membreMesprojet.php">Mes projets</a></li>
            ...
            <div class="panel-body">
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        $requete = " SELECT DISTINCT nomprojet, datedebutpro,etatprojet,budget, nomemp
                                     FROM projet, employe, tache, affecter
                                    WHERE tache.idprojet IN  ( SELECT DISTINCT idprojet
                                                                fROM affecter, tache
                                                                  WHERE affecter.idemp = $id
