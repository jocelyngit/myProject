            ...
            <div class="col-md-12">
                <div class="navbar-collapse collapse ">
                    <ul id="menu-top" class="nav navbar-nav navbar-right">
                        <li><a class="menu-top-active" href="clientMesprojet.php">Mes projets</a></li>
                        <li><a href="pageClientsuivi.php">suivis</a></li>
            ...
            <div class="panel-body">
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        $requete = " SELECT DISTINCT nomprojet, datedebutpro, typepro, budget, nomemp, nomclient
                             FROM  employe, projet, client
                             WHERE projet.idclient = $id
