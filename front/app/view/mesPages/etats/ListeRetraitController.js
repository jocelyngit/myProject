 ...
 */
Ext.define('zonblewou.view.mesPages.etats.ListeRetraitController', {

    extend: 'Ext.app.ViewController',

    alias: 'controller.listeretraitcontroller',
    ...
    */
    ...
    onBtnEtatRetraitPrint : function()
    {
    ...
    onBtnEtatRetraitReset : function () {
        var me = this,
            v = me.getView(),
            myStore = v.getStore(),
            dateField = me.lookupReference('dateEtatRetraitRef'),
