 ...
 */
Ext.define('zonblewou.view.mesPages.etats.CommissionListeController', {

    extend: 'Ext.app.ViewController',

    alias: 'controller.commissionliste',
    ...
    */
    ...
    onMoisComboSelectComListe : function (combo, record)
    {
        ...
        var me = this,
            ...
            cbAgent = me.lookupReference('agentComboComListeRef');
        ...
        Ext.data.JsonP.request({
            ...
            url: zonblewou.vars.AllVars.url + '/api/commission/commissionParMois?classe=Commission&format=json',
    ...
    onAgentComboSelectComListe : function(combo, record)
    {
        ...
        var me = this,
            v = me.getView(),
            myStore = v.getStore(),
            cbMois = me.lookupReference('moisComboComListeRef'),
        ...
        Ext.data.JsonP.request({
            ...
            url: zonblewou.vars.AllVars.url + '/api/commission/commissionAgentParMois?classe=Commission&format=json',
    ...
    onBtnCommissionListePrint : function()
    {
    ...
    onBtnCommissionListeReset : function () {
        var me = this,
            v = me.getView(),
            myStore = v.getStore(),
            cbMois = me.lookupReference('moisComboComListeRef'),
