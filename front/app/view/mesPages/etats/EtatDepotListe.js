...
Ext.define('zonblewou.view.mesPages.etats.EtatDepotListe', {
    ...
    dockedItems: [
        {
            ...
            items: [
                '-',{
                    ...
                    //listners
                    listeners: {
                        change: 'onDateOfListeDepotChange'
                    }
