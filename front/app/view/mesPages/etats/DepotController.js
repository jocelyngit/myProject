 ...
 */
Ext.define('zonblewou.view.mesPages.etats.DepotController', {

    extend: 'Ext.app.ViewController',

    alias: 'controller.depotcontroller',
    ...
    */
    ...
    onDateOfListeDepotChange: function(field, value)
    {
        ...
        Ext.data.JsonP.request({
            ...
            url: zonblewou.vars.AllVars.url + '/api/depotMarketeur/depotParDate?classe=DepotMarketeur&format=json',

            params: { 'dateDepot': dateSelec },
    ...
    onComboMoisDepotSelect : function (combo, record)
    {
        ...
        Ext.data.JsonP.request({
            ...
            url: zonblewou.vars.AllVars.url + '/api/depotMarketeur/depotParMois?classe=DepotMarketeur&format=json',
