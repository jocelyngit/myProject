 ...
 */
Ext.define('zonblewou.view.mesPages.etats.ListeCotisationController', {

    extend: 'Ext.app.ViewController',

    alias: 'controller.listecotisationcontroller',
    ...
    */
    ...
    onDateFieldOfListeCotisationChange: function(field, value)
    {
        ...
        Ext.data.JsonP.request({
            ...
            url: zonblewou.vars.AllVars.url + '/api/cotisation/cotisationParDate?classe=Cotisation&format=json',

            params: { 'dateCotisation': dateSelec },
    ...
    onComboMoiselect : function (combo, record)
    {
        ...
        var me = this,
            ...
            cbAgent = me.lookupReference('agentComboLCRef');
        ...
        Ext.data.JsonP.request({
            ...
            url: zonblewou.vars.AllVars.url + '/api/cotisation/cotisationParMois?classe=Cotisation&format=json',
    ...
    onAgentComboSelectLC : function(combo, record)
    {
        ...
        var me = this,
            v = me.getView(),
            myStore = v.getStore(),
            cbMois = me.lookupReference('moisComboLCRef'),
        ...
        Ext.data.JsonP.request({
            ...
            url: zonblewou.vars.AllVars.url + '/api/cotisation/cotisationAgentParMois?classe=Cotisation&format=json',
    ...
    onBtnListeCotisationPrint : function()
    {
    ...
    onBtnCotisationListeReset : function () {
        var me = this,
            v = me.getView(),
            myStore = v.getStore(),
            dateField = me.lookupReference('dateCotisationLcRef'),
            cbMois = me.lookupReference('moisComboLCRef'),
            cbAgent = me.lookupReference('agentComboLCRef');
