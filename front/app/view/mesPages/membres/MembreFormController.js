    ...
    onEditMembreAction: function(grid, rowIndex, colIndex) {
        ...
        Ext.create('Ext.window.Window', {
            ...
            requires: [
                ...
                'zonblewou.store.mesStore.Nationalites',
                            ...
                            },
                            {
                                ...
                                listeners: {
                                    ...
                                    afterrender: function() {
                                        ...
                                        //this.setValue(rec.get('sitMatrimoniale'));

                                        //console.log('sectactiviteafterrender');
                                        ...
                                        this.getStore().each(function(record) {
                                            ...
                                            //console.log(record.get('valeur'));

                                            if (record.get('valeur') === rec.get('sitMatrimoniale')) {
                        ...
                        items: [
                            {
                                ...
                                listeners: {
                                    ...
                                    afterrender: function() {
                                        ...
                                        this.setValue(rec.get('idProfession'));
                            ...
                            },
                            {
                                ...
                                listeners: {
                                    ...
                                    afterrender: function(combo, record) {
                                        ...
                                        this.setValue(rec.get('idSecteur'));
                        ...
                        items: [
                            {
                                ...
                                listeners: {
                                    ...
                                    afterrender: function() {
                                        ...
                                        //this.setValue(rec.get('nationalite'));

                                        //var donne = this.getStore().getData().items
                                        //console.log(donne[0]['id']);

                                        //this.setValue(donne[0]['id']);
                                        ...
                                        this.getStore().each(function(record) {
                                            ...
                                            if (record.get('nationalite') === rec.get('nationalite') ) {
                            ...
                            },
                            {
                                ...
                                listeners: {
                                    ...
                                    afterrender: function() {
                                        ...
                                        //this.setValue(rec.get('{nomAgent} {prenomAgent}'));

                                        this.setValue(rec.get('idAgent'));
