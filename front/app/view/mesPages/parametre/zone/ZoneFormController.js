 ...
 */
Ext.define('zonblewou.view.mesPages.parametre.zone.ZoneFormController', {

    extend: 'Ext.app.ViewController',

    alias: 'controller.zoneform',
    ...
    */
    ...
    /*
      METHODE ENREGISTREMENT ZONE
    */

    onEnregZoneButtonClick: function() {
        ...
        */
        ...
        var form = this.lookupReference('zoneFormRef');
        ...
        */
        ...
        var grid = Ext.ComponentQuery.query("zoneListe[title='LISTE DES ZONES']");
                ...
                if (btn === 'yes') {
                    ...
                    */
                    ...
                    Ext.data.JsonP.request({
                        ...
                        url: zonblewou.vars.AllVars.url + '/api/zone/store?classe=Zone&format=json',
    ...
    */
    ...
    onZoneEditAction: function(grid, rowIndex, colIndex) {
                                    ...
                                    if (btn === 'yes') {
                                        ...
                                        */
                                        ...
                                        Ext.data.JsonP.request({
                                            ...
                                            url: zonblewou.vars.AllVars.url + '/api/zone/update?classe=Zone&format=json',
    ...
    */
    ...
    onZoneDeleteAction: function(grid, rowIndex, colIndex) {
