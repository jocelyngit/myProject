 ...
 */
Ext.define('zonblewou.view.mesPages.parametre.agence.AgenceFormController', {

    extend: 'Ext.app.ViewController',

    alias: 'controller.agenceform',
    ...
    */
    ...
    onEnregAgenceButtonClick: function() {

        /*
            RECUPERATION DES DONNEES DU FORMULAIRE
        */

        var form = this.lookupReference('agenceFormRef');
        ...
        */
        ...
        var grid = Ext.ComponentQuery.query("agenceListe[title='LISTE DES AGENCES']");
                ...
                if (btn === 'yes') {
                    ...
                    */
                    ...
                    Ext.data.JsonP.request({
                        ...
                        url: zonblewou.vars.AllVars.url + '/api/agence/store?classe=Agence&format=json',
    ...
    */
    ...
    onAgenceEditAction: function(grid, rowIndex, colIndex) {
                            ...
                            Ext.Msg.show({
                                ...
                                fn: function(btn) {
                                    if (btn === 'yes') {
                                        ...
                                        // fermeture de la fenetre de modification
                                        fen.close();
                                        ...
                                        */
                                        ...
                                        Ext.data.JsonP.request({
                                            ...
                                            url: zonblewou.vars.AllVars.url + '/api/agence/update?classe=Agence&format=json',
    ...
    */
    ...
    onAgenceDeleteAction: function(grid, rowIndex, colIndex) {
            ...
            fn: function(button) {
                ...
                if ('yes' == button) {
                    ...
                    Ext.data.JsonP.request({
                        ...
                        url: zonblewou.vars.AllVars.url + '/api/agence/destroy',
