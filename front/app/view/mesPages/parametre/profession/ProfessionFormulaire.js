Ext.define('zonblewou.view.mesPages.parametre.profession.ProfessionFormulaire', {
    ...
    items: [{
            xtype: 'form',
            title: 'ENREGISTRER UNE PROFESSION',
            reference: 'professionFormRef',
            ...
            items: [{
                ...
                },
                {
                    ...
                    formBind: true,
                    listeners: {
                        click: 'onEnregProfessionButtonClick'
                    }
