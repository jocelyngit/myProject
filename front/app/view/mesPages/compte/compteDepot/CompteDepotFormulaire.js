Ext.define('zonblewou.view.mesPages.compte.compteDepot.CompteDepotFormulaire', {
    ...
    items: [{
            xtype: 'form',
            title: 'ENREGISTRER UN COMPTE DE DEPOT',
            reference: 'compteDepotFormRef',
            ...
            items: [{
                ...
                },
                {
                    ...
                    formBind: true,
                    listeners: {
                        click: 'onEnregCompteDepotButtonClick'
                    }
