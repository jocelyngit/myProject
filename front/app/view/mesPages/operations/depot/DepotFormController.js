    ...
    onAgentComboDepotMarketeurSelect: function(combo, records, eOpts) {
        ...
        Ext.data.JsonP.request({
            ...
            success: function(response) {
                ...
                var idCompteDepotField = this.lookupReference('idCptDepHiddenField');

                var numCompteDepotField = this.lookupReference('numCompteDepRef');

                // affectation des valeurs

                numCompteDepotField.setValue(response[0]['numCompteDep']);

                idCompteDepotField.setValue(response[0]['id']);
                ...
                if (btn === 'yes') {
                    ...
                    */
                    ...
                    Ext.data.JsonP.request({
                        ...
                        url: zonblewou.vars.AllVars.url + '/api/depotMarketeur/store?classe=DepotMarketeur&format=json',
