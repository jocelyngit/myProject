Ext.define('zonblewou.view.coordinateur.CoordinateurMain', {
    ...
    items: [{
        ...
        {
            xtype: 'coormaincontainerwrap',
            id: 'coormain-view-detail-wrap',
            reference: 'coormainContainerWrapRef',
            flex: 1,
            items: [{
                    xtype: 'treelist',
                    reference: 'coornavigationTreeList',
                    itemId: 'coornavigationTreeList',
                    ui: 'navigation',
                    store: 'CoordinateurNavTree',
                    width: 250,
                    expanderFirst: false,
                    expanderOnly: false,
                    listeners: {
