 ...
 */
Ext.define('zonblewou.view.caisseView.etatcaisse.ListeRetraitcController', {

    extend: 'Ext.app.ViewController',

    alias: 'controller.listeretraitccontroller',
    ...
    */
    ...
    onDateFieldOfEtatRetraitcChange: function(field, value)
    {
        ...
        Ext.data.JsonP.request({
            ...
            url: zonblewou.vars.AllVars.url + '/api/operation/retraitParDateParOperateur?classe=Operation&format=json',

            params: { 'dateOperation': dateSelec, 'idUser': zonblewou.vars.AllVars.idUser },
    ...
    onEtatRetraitcComboMoisSelect : function (combo, record)
    {
    ...
    onBtnEtatRetraitcPrint : function()
    {
    ...
    onBtnEtatRetraitcReset : function () {
        var me = this,
            v = me.getView(),
            myStore = v.getStore(),
            dateField = me.lookupReference('dateEtatRetraitcRef'),
            cbMois = me.lookupReference('moisComboEtatRetraitcRef');
