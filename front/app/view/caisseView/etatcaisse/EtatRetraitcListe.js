Ext.define('zonblewou.view.caisseView.etatcaisse.EtatRetraitcListe', {
   ...
   // reference: 'retraitGridRef',
    ...
    controller: 'listeretraitccontroller',
    ...
    dockedItems: [
        {
            ...
            items: [
                '-',{
                    ...
                    //listners
                    listeners: {
                        change: 'onDateFieldOfEtatRetraitcChange'
                    }
...

                {
                    ...
                    fieldLabel: 'Mois',
                    labelAlign: 'left',
                    reference : 'moisComboEtatRetraitcRef',
                    forceSelection: true,
                    ...
                    listeners: {
                        select : 'onEtatRetraitcComboMoisSelect'
                    }
                },
                '-',
               /* {
                ...
                */
                ...
                '->',
                {
                    ...
                    //}
                    handler : 'onBtnEtatRetraitcReset'
                },
                '-',
                {
                    xtype: 'button', //#27
