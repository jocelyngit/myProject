Ext.define('zonblewou.profile.Phone', {
    extend: 'Ext.app.Profile',

    requires: [
        'zonblewou.view.phone.*'
    ],

    // Map phone profile views to generic xtype aliases:
    //
    views: {
        email: 'zonblewou.view.phone.email.Email',
        inbox: 'zonblewou.view.phone.email.Inbox',
        compose: 'zonblewou.view.phone.email.Compose',

        searchusers: 'zonblewou.view.phone.search.Users'
    },
