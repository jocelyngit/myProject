//var userName = zonblewou.vars.AllVars.nomUser;
Ext.define('zonblewou.view.main.Main', {
    extend: 'Ext.container.Viewport',

    requires: [
        'Ext.button.Segmented',
        'zonblewou.vars.AllVars',
        'Ext.list.Tree'
    ],
    ...
    items: [{
            ...
            items: [{
...

                {
                    xtype: 'tbtext',
                    text: userName,
                    //html: '<p>zonblewou.vars.AllVars.nomUser</p>}',
                    //text: '{zonblewou.vars.AllVars.nomUser} {zonblewou.vars.AllVars.prenomUser}',
                    cls: 'top-user-name',
                    //text: '{zonblewou.vars.AllVars.nomUser}',
