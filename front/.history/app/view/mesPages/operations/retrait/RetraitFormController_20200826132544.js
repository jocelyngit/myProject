    ...
    onValiderRetButtonClick: function() {
        ...
        */
        ...
        if (p['typeOpp'] == "oct") {
            ...
            if (p['montantOperation'] > p['oct']) {

                Ext.Msg.show({
                    title: 'ERREUR',
                    msg: 'Montant du retrait est supérieur au solde O.C.T.',
                    width: 250,
                    buttons: Ext.Msg.OK,
                    fn: function(btn) {
                        if (btn == 'ok') {
            ...
            if (p['montantOperation'] > p['omt']) {

                Ext.Msg.show({
                    title: 'ERREUR',
                    msg: 'Montant du retrait est supérieur au solde O.M.T.',
                    width: 250,
                    buttons: Ext.Msg.OK,
                    fn: function(btn) {
                        if (btn == 'ok') {
            ...
            if (p['montantOperation'] > p['olt']) {

                Ext.Msg.show({
                    title: 'ERREUR',
                    msg: 'Montant du retrait est supérieur au solde O.L.T.',
                    width: 250,
                    buttons: Ext.Msg.OK,
                    fn: function(btn) {
                        if (btn == 'ok') {
