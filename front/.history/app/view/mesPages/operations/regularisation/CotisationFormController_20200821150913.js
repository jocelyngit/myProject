    ...
    onAgentComboRegularisationSelect: function(combo, records, eOpts) {
        ...
        Ext.data.JsonP.request({
            ...
            success: function(response) {
                ...
                montantVerseField.setValue(infoAgent[0]['montantDepot']);

                reste.setValue(infoAgent[0]['montantDepot']);

                idCompteDepField.setValue(infoAgent[0]['idCptDepot']);
