 ...
 */
Ext.define('zonblewou.view.mesPages.parametre.typeOperation.TypeOperationFormController', {

    extend: 'Ext.app.ViewController',

    alias: 'controller.typeoperationform',
    ...
    */
    ...
    onEnregTypeOperationButtonClick: function() {
        ...
        */
        ...
        var form = this.lookupReference('typeOperationFormRef');
        ...
        */
        ...
        var grid = Ext.ComponentQuery.query("tOperationListe[title='LISTE DES TYPES D\'OPERATIONS']");
                ...
                if (btn === 'yes') {
                    ...
                    */
                    ...
                    Ext.data.JsonP.request({
                        ...
                        url: zonblewou.vars.AllVars.url + '/api/typeOperation/store?classe=TypeOperation&format=json',
    ...
    */
    ...
    onTypeOperationEditAction: function(grid, rowIndex, colIndex) {
                                    ...
                                    if (btn === 'yes') {
                                        ...
                                        */
                                        ...
                                        Ext.data.JsonP.request({
                                            ...
                                            url: zonblewou.vars.AllVars.url + '/api/typeOperation/update?classe=TypeOperation&format=json',
    ...
    */
    ...
    onTypeOperationDeleteAction: function(grid, rowIndex, colIndex) {
            ...
            fn: function(button) {
                ...
                if ('yes' == button) {
                    ...
                    Ext.data.JsonP.request({
                        ...
                        url: zonblewou.vars.AllVars.url + '/api/typeOperation/destroy',
                    ...
                    /*
                      SUPPRESSION DE L'ENREGISTREMENT DANS LE STORE
                    */
