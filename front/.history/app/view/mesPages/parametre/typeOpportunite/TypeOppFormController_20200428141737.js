 ...
 */
Ext.define('zonblewou.view.mesPages.parametre.typeOpportunite.TypeOppFormController', {

    extend: 'Ext.app.ViewController',

    alias: 'controller.typeoppform',
    ...
    */
    ...
    onEnregTypeOppButtonClick: function() {
        ...
        */
        ...
        var form = this.lookupReference('typeOppFormRef');
        ...
        */
        ...
        var grid = Ext.ComponentQuery.query("tOppListe[title='LISTE DES TYPES D\'OPPORTUNITES']");
        ...
        */
        ...
        Ext.data.JsonP.request({
            ...
            url: 'http://localhost:8000/api/typeOpportunite/store?classe=TypeOpportunite&format=json',
    ...
    */
    ...
    onTypeOppEditAction: function(grid, rowIndex, colIndex) {
                        ...
                        handler: function() {
                            ...
                            */
                            ...
                            Ext.data.JsonP.request({
                                ...
                                url: 'http://localhost:8000/api/typeOpportunite/update?classe=TypeOpportunite&format=json',
    ...
    */
    ...
    onTypeOppDeleteAction: function(grid, rowIndex, colIndex) {
            ...
            fn: function(button) {
                ...
                if ('yes' == button) {
                    ...
                    Ext.data.JsonP.request({
                        ...
                        url: 'http://localhost:8000/api/typeOpportunite/destroy',

                        params: {
                            'id': rec.get('id'),
                            //rec.data,
                            'classe': 'TypeOpportunite'
                        },
