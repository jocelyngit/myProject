 ...
 */
Ext.define("MutrasstoApp.ux.grid.Printer", {
    ...
    statics: {
        ...
        print: function(grid, featureId) {
            ...
            if (this.stylesheetPath === null) {
                var scriptPath = Ext.Loader.getPath('MutrasstoApp.ux.grid.Printer');
         ...
         */
        stylesheetPath: 'gridPrinterCss/print.css',
