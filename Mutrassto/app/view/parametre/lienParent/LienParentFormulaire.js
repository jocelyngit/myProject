Ext.define('MutrasstoApp.view.parametre.lienParent.LienParentFormulaire', {
    extend: 'Ext.form.Panel',

    xtype: 'formulaire-lienParent',
    title: 'ENREGISTRER UN LIEN PARENT',
    layout: 'form',
    frame: true,
    ...
    buttons: [{
        ...
        handler: function() {
            ...
            var url = 'http://localhost:8080/lienParent/create?classe=LienParent&format=json'
