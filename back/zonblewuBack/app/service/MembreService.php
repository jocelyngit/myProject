     ...
     */
     ...
     public function findAll(string $class)
     {
        ...
        $membres = DB::table('membres')
            ...
            ->select('membres.id as id', 'numeroMembre','nomMembre','prenomMembre', 'professions.id as idProfession','profession', 'secteur_activites.id as idSecteur', 'secteurActivite','nationalite', 'sexe', 'sitMatrimoniale', 'adresseMembre', 'telMembre', 'dateAdhesion', 'mise', 'projetAvenir', 'dureeProjet', 'agent_marketings.id as idAgent', 'agent_marketings.nomAg as nomAgent', 'agent_marketings.prenomAg as prenomAgent', 'users.id as idUser', 'users.login as nomUtilisateur')
