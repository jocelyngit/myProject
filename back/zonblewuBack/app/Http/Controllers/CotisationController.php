...
class CotisationController extends Controller
{
    ...
    public function allCotisation(Request $req){
    ...
    $donnee = $this->cotisationInstance->allCotisation($class);

    return \response()->json( $donnee, 200)->withCallback($req->input('callback'));

}

    public function cotisationParDate(Request $req){
        ...
        $donnee = $this->cotisationInstance->cotisationParDate($req);

        return \response()->json( $donnee, 200)->withCallback($req->input('callback'));

    }

    public function cotisationParMois(Request $req){
        ...
        $donnee = $this->cotisationInstance->cotisationParMois($req);

        return \response()->json( $donnee, 200)->withCallback($req->input('callback'));

    }

    public function cotisationAgentParMois(Request $req){
        ...
        $donnee = $this->cotisationInstance->cotisationAgentParMois($req);
