...
class DepotMarketeurController extends Controller
{
    ...
    public function getDepotDuJour(Request $req)
    {
        ...
        $resultat = $this->DepMarketeurInstance->getDepotDuDjour($id);
    ...
    public function allDepotMarketeur(Request $req)
    {
        ...
        $resultat = $this->DepMarketeurInstance->allDepotMarketeur();

        return \response()->json($resultat, 201)->withCallback($req->input('callback'));
    }

    public function depotParDate(Request $req){
        ...
        $donnee = $this->DepMarketeurInstance->depotParDate($req);

        return \response()->json( $donnee, 200)->withCallback($req->input('callback'));

    }

    public function depotParMois(Request $req){
        ...
        $donnee = $this->DepMarketeurInstance->depotParMois($req);

        return \response()->json( $donnee, 200)->withCallback($req->input('callback'));

    }

    public function depotAgentParMois(Request $req){
        ...
        $donnee = $this->DepMarketeurInstance->depotAgentParMois($req);

        return \response()->json( $donnee, 200)->withCallback($req->input('callback'));

    }

    public function depotOperateurParJour(Request $req){
        ...
        $donnee = $this->DepMarketeurInstance->depotOperateurParJour($req);

        return \response()->json( $donnee, 200)->withCallback($req->input('callback'));

    }

    public function depotOperateurParMois(Request $req){
        ...
        $donnee = $this->DepMarketeurInstance->depotOperateurParMois($req);
