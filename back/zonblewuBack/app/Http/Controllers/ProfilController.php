...
class ProfilController extends Controller
{
    ...
    public function show(Request $request)
    {
        ...
        //creation de l'objet
        $objet = $this->profilInstance->show($request, $id);
    ...
    public function destroy(Request $request)
    {
        ...
        $this->profilInstance->destroy($request, $id);
    ...
    public function getProfil(Request $request)
    {
        ...
        $libProfil = $this->profilInstance->getProfilById($request);

        return \response()->json($libProfil, 201)->withCallback($request->input('callback'));
