...
Route::group(['prefix' => 'compte'], function () {
    ...
    Route::get('/soldeCaisse', 'CompteController@soldeCaisse');
...
Route::group(['prefix' => 'cotisation'], function () {
    ...
    Route::get('/cotisationParDate', 'CotisationController@cotisationParDate');

    Route::get('/cotisationParMois', 'CotisationController@cotisationParMois');

    Route::get('/cotisationAgentParMois', 'CotisationController@cotisationAgentParMois');
...
Route::group(['prefix' => 'operation'], function () {
    ...
    Route::get('/allRetrait', 'OperationController@allRetrait');

    Route::get('/retraitParDate', 'OperationController@retraitParDate');

    Route::get('/retraitParMois', 'OperationController@retraitParMois');

    Route::get('/retraitOperateurParMois', 'OperationController@retraitOperateurParMois');

    Route::get('/retraitParDateParOperateur', 'OperationController@retraitParDateParOperateur');
...
Route::group(['prefix' => 'opportunite'], function () {
    ...
    Route::get('/allCompteOpp', 'OpportuniteController@allCompteOpp');
...
Route::group(['prefix' => 'profession'], function () {
  ...
  */
  ...
  Route::group(['prefix' => 'depotMarketeur'], function () {
    ...
    Route::get('/allDepotMarketeur', 'DepotMarketeurController@allDepotMarketeur');

    Route::get('/depotParDate', 'DepotMarketeurController@depotParDate');

    Route::get('/depotParMois', 'DepotMarketeurController@depotParMois');

    Route::get('/depotAgentParMois', 'DepotMarketeurController@depotAgentParMois');

      Route::get('/depotOperateurParJour', 'DepotMarketeurController@depotOperateurParJour');

      Route::get('/depotOperateurParMois', 'DepotMarketeurController@depotOperateurParMois');
...
Route::group(['prefix' => 'commission'], function () {
    ...
    Route::get('/show', 'CommissionController@show');

    Route::get('/store', 'CommissionController@store');

    Route::get('/update', 'CommissionController@update');

    Route::get('/destroy', 'CommissionController@destroy');

    Route::get('/commissionParMois', 'CommissionController@commissionParMois');

    Route::get('/commissionAgentParMois', 'CommissionController@commissionAgentParMois');
