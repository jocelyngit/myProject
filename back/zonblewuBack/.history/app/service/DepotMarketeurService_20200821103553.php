...
class DepotMarketeurService extends GenericService
{
    ...
    public function findAll(string $class)
    {
        ...
        $depotMarketeurListe = DB::table('depot_maeketeurs')

        ->join('agent_marketings', 'depot_marketeurs.idAgent', '=', 'agent_marketings.id')

        ->join('compte_de_depots', 'depot_marketeurs.idCptDep', '=', 'compte_de_depots.id')

        ->select('depot_marketeurs.id as id','numCompteDep','dateDepot', 'montantDepot', 'agent_marketings.nomAg as nomAg','agent_marketings.prenomAg as prenomAg')
