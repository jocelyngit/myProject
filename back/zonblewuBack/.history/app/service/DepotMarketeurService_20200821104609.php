...
class DepotMarketeurService extends GenericService
{
    ...
    public function findAll(string $class)
    {
        ...
        ->select('depot_marketeurs.id as id', 'agent_marketings.id as idAgent','numCompteDep','dateDepot', 'montantDepot', 'agent_marketings.nomAg as nomAg','agent_marketings.prenomAg as prenomAg')
