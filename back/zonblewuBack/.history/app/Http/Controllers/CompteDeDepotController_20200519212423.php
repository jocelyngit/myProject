...
class CompteDeDepotController extends Controller
{
    ...
    public function infoCompteDepot(Request $req)
    {
        ...
        $resultat = $this->compteDeDepotInstance->infoCompteDepot($id);
    ...
    public function depot(Request $request)
    {
        ...
        // modification
        $instanceModifie = $this->compteDeDepotInstance->depot($request);
